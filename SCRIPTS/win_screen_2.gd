...
# Soglie medaglie Livello 2 (in secondi)
const SOGLIA_ORO := 105.0      # entro 1'45"
const SOGLIA_ARGENTO := 165.0  # entro 2'45"
const SOGLIA_BRONZO := 300.0   # entro 5'
...
func mostra() -> void:
	...
	Progress.completa_livello(1, medaglia)
